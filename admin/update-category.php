...
if (isset($_GET['submit'])) {
  ...
  //       if ($remove == false) {
  //         $_SESSION['failed-remove'] = "<div class='text-error'> Failed to Remove Image Category</div>";
  //         header('location:' . SITEURL . 'admin/manage-category.php');
  //         die();
  //       }
  //     }
  ...
  // if ($res == True) {
  //   $_SESSION['update'] = " <div class='text-succes'> Update Category Succesfully </div>";
  //   header("location:" . SITEURL . 'admin/manage-category.php');
  // } else {
  //   $_SESSION['update'] = "<div class='text-error'> Failed to Update Category  </div>";
